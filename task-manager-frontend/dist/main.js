...
const addPostButton = document.getElementById('add-task-button');
...
const messageBoxConfirmButton = document.getElementById('message-box-confirm');
...
function showMessageBox(title, message, isConfirm = false) {
    ...
    const onConfirmHandler = () => {
        ...
        if (messageBoxConfirmButton._resolve)
            messageBoxConfirmButton._resolve(true);
    };
    const onCancelHandler = () => {
        ...
        messageBoxCancelButton.removeEventListener('click', onCancelHandler);
        // @ts-ignore
        if (messageBoxCancelButton._resolve)
            messageBoxCancelButton._resolve(false);
    };
...
function renderTask(task) {
    ...
    deleteButton.addEventListener('click', async () => {
        ...
        const confirmed = await showMessageBox('Kumpirmahin ang Pagtanggal', `Sigurado ka bang gusto mong tanggalin ang "${task.text}"?`, true);
